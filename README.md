...
Данный проект реализует учебную систему модерации сообщений на базе **Apache Kafka** и **Kafka Streams**.
...
Проект выполнен в учебном стиле, без лишнего усложнения:
- без JSON и Avro
- без внешней базы данных
- без сложной бизнес-логики
- с использованием **persistent state store** Kafka Streams
